...
<body class="index-page">
    ...
    <main class="main">
            ...
            <div class="container">
                <div class="row gy-4 justify-content-center justify-content-lg-between">
                    <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center">
                        <h1 data-aos="fade-up">
                            Enjoy Your Fresh Laundry<br>
                            <span style="font-size: 0.8em;">Delight in Clean, Fresh Clothes</span>
                        </h1>
                        <p data-aos="fade-up" data-aos-delay="100">We are team of talented designers making websites
                            with Bootstrap</p>
                        <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                            <a href="/cek-status" class="btn-get-started">Cek Pesanan</a>
                    ...
                    <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                        <img src="{{ asset('yummy/assets/img/cc.png') }}" class="img-fluid animated" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
                        <img src="{{ asset('yummy/assets/img/ab.jpeg') }}" class="img-fluid mb-4" alt="">
                    ...
                    <div class="col-lg-5" data-aos="fade-up" data-aos-delay="250">
                        <div class="content ps-0 ps-lg-5">
                            ...
                            <div class="position-relative mt-4">
                                <img src="{{ asset('yummy/assets/img/ab2.jpg') }}" class="img-fluid" alt="">
                                <a href="https://www.youtube.com/watch?v=Y7f98aduVJ8"
        ...
        <section id="stats" class="stats section dark-background">
            ...
            <img src="{{ asset('yummy/assets/img/ke3.jpg') }}" alt="" data-aos="fade-in">
                ...
                <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="tab-pane fade active show" id="menu-starters">
                        ...
                        <div class="row gy-5">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('yummy/assets/img/menu/menu-item-1.png') }}" class="glightbox">
                                    <img src="{{ asset('yummy/assets/img/menu/menu-item-1.png') }}"
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('yummy/assets/img/menu/menu-item-2.png') }}" class="glightbox">
                                    <img src="{{ asset('yummy/assets/img/menu/menu-item-2.png') }}"
                                        class="menu-img img-fluid" alt="">
                                </a>
                                <h4>Aut Luia</h4>
                                <p class="ingredients">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('yummy/assets/img/menu/menu-item-3.png') }}" class="glightbox">
                                    <img src="{{ asset('yummy/assets/img/menu/menu-item-3.png') }}"
                                        class="menu-img img-fluid" alt="">
                                </a>
                                <h4>Est Eligendi</h4>
                                <p class="ingredients">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('yummy/assets/img/menu/menu-item-4.png') }}" class="glightbox">
                                    <img src="{{ asset('yummy/assets/img/menu/menu-item-4.png') }}"
                                        class="menu-img img-fluid" alt="">
                                </a>
                                <h4>Eos Luibusdam</h4>
                                <p class="ingredients">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('yummy/assets/img/menu/menu-item-5.png') }}" class="glightbox">
                                    <img src="{{ asset('yummy/assets/img/menu/menu-item-5.png') }}"
                                        class="menu-img img-fluid" alt="">
                                </a>
                                <h4>Eos Luibusdam</h4>
                                <p class="ingredients">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('yummy/assets/img/menu/menu-item-6.png') }}" class="glightbox">
                                    <img src="{{ asset('yummy/assets/img/menu/menu-item-6.png') }}"
                                        class="menu-img img-fluid" alt="">
                                </a>
                    ...
                    <div class="tab-pane fade" id="menu-breakfast">
                        ...
                        <div class="row gy-5">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="yummy/assets/img/menu/menu-item-1.png" class="glightbox"><img
                                        src="yummy/assets/img/menu/menu-item-1.png" class="menu-img img-fluid"
                                        alt=""></a>
                                <h4>Magnam Tiste</h4>
                                <p class="ingredients">
                                    Lorem, deren, trataro, filede, nerada
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="yummy/assets/img/menu/menu-item-2.png" class="glightbox"><img
                                        src="yummy/assets/img/menu/menu-item-2.png" class="menu-img img-fluid"
                                        alt=""></a>
                                <h4>Aut Luia</h4>
                                <p class="ingredients">
                                    Lorem, deren, trataro, filede, nerada
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="yummy/assets/img/menu/menu-item-3.png" class="glightbox"><img
                                        src="yummy/assets/img/menu/menu-item-3.png" class="menu-img img-fluid"
                                        alt=""></a>
                                <h4>Est Eligendi</h4>
                                <p class="ingredients">
                                    Lorem, deren, trataro, filede, nerada
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="yummy/assets/img/menu/menu-item-4.png" class="glightbox"><img
                                        src="yummy/assets/img/menu/menu-item-4.png" class="menu-img img-fluid"
                                        alt=""></a>
                                <h4>Eos Luibusdam</h4>
                                <p class="ingredients">
                                    Lorem, deren, trataro, filede, nerada
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="yummy/assets/img/menu/menu-item-5.png" class="glightbox"><img
                                        src="yummy/assets/img/menu/menu-item-5.png" class="menu-img img-fluid"
                                        alt=""></a>
                                <h4>Eos Luibusdam</h4>
                                <p class="ingredients">
                                    Lorem, deren, trataro, filede, nerada
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="yummy/assets/img/menu/menu-item-6.png" class="glightbox"><img
                                        src="yummy/assets/img/menu/menu-item-6.png" class="menu-img img-fluid"
                                        alt=""></a>
                                <h4>Laboriosam Direva</h4>
                                <p class="ingredients">
                                    Lorem, deren, trataro, filede, nerada
                  ...
                  "spaceBetween": 1
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                            style="background-image: url({{ asset('yummy/assets/img/events-1.jpg') }})">
                        ...
                        <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                            style="background-image: url({{ asset('yummy/assets/img/events-2.jpg') }})">
                        ...
                        <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                            style="background-image: url({{ asset('yummy/assets/img/events-3.jpg') }})">
                        ...
                        <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                            style="background-image: url({{ asset('yummy/assets/img/events-4.jpg') }})">
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                        <div class="team-member">
                            <div class="member-img">
                                <img src="{{ asset('yummy/assets/img/chefs/chefs-2.jpg') }}" class="img-fluid" alt="Chef Image">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                                    <a href=""><i class="bi bi-instagram"></i></a>
                    ...
                    <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                        <div class="team-member">
                            <div class="member-img">
                                <img src="{{ asset('yummy/assets/img/chefs/chefs-3.jpg') }}" class="img-fluid" alt="Chef Image">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                                    <a href=""><i class="bi bi-instagram"></i></a>
        ...
        <section id="book-a-table" class="book-a-table section">
            ...
            <div class="container">
                ...
                <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 reservation-img" style="background-image: url(yummy/assets/img/reservation.jpg);">
                    </div>
                    ...
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('yummy/assets/img/gallery/gallery-1.jpg') }}">
                                <img src="{{ asset('yummy/assets/img/gallery/gallery-1.jpg') }}" class="img-fluid"
                                    alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('yummy/assets/img/gallery/gallery-2.jpg') }}">
                                <img src="{{ asset('yummy/assets/img/gallery/gallery-2.jpg') }}" class="img-fluid"
                                    alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('yummy/assets/img/gallery/gallery-3.jpg') }}">
                                <img src="{{ asset('yummy/assets/img/gallery/gallery-3.jpg') }}" class="img-fluid"
                                    alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('yummy/assets/img/gallery/gallery-4.jpg') }}">
                                <img src="{{ asset('yummy/assets/img/gallery/gallery-4.jpg') }}" class="img-fluid"
                                    alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('yummy/assets/img/gallery/gallery-5.jpg') }}">
                                <img src="{{ asset('yummy/assets/img/gallery/gallery-5.jpg') }}" class="img-fluid"
                                    alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('yummy/assets/img/gallery/gallery-6.jpg') }}">
                                <img src="{{ asset('yummy/assets/img/gallery/gallery-6.jpg') }}" class="img-fluid"
                                    alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('yummy/assets/img/gallery/gallery-7.jpg') }}">
                                <img src="{{ asset('yummy/assets/img/gallery/gallery-7.jpg') }}" class="img-fluid"
                                    alt="">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="glightbox" data-gallery="images-gallery"
                                href="{{ asset('yummy/assets/img/gallery/gallery-8.jpg') }}">
                                <img src="{{ asset('yummy/assets/img/gallery/gallery-8.jpg') }}" class="img-fluid"
                                    alt="">
                            </a>
                        </div>
                    </div>
