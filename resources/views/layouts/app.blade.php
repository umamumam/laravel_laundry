...
<head>
    ...
    <style>
        /* Pastikan Select2 menyatu dengan input-group */
        .input-group .select2-container {
            flex: 1;
            /* Memastikan Select2 memenuhi input-group */
        }
        ...
        /* Agar Select2 tidak memiliki border ganda */
        .input-group .select2-container--default .select2-selection--single {
            border-radius: 0 0.375rem 0.375rem 0;
        }

        /* Sesuaikan warna font Select2 dengan Bootstrap */
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative d-flex flex-column min-vh-100 max-height-vh-100 h-100 border-radius-lg">
        <!-- Navbar -->
